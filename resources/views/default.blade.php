...
<head>
  ...
  <title>AFRICAN ASSISTANCE TECNOLOGIE</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{asset('assets/img/logo.png')}}" rel="icon" type="image/png" sizes="16x16">
...
<body>
  ...
  <div id="topbar" class="d-none d-lg-flex align-items-center fixed-top ">
    <div class="container d-flex align-items-center">
      <div class="contact-info mr-auto">
        <ul>
          <li><i class="icofont-envelope"></i><a href="mailto:2atechnologie@gmail.com">2atechnologie@gmail.com</a></li>
          <li><i class="icofont-phone"></i> +221 77 100 00 00</li>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>2aTechnologies</span></strong>. 
      </div>
